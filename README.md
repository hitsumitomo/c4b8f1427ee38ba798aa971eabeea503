...
2. **Navigate to the project directory**
    ...
    ```
3. **Update the environment variables in the `docker-compose.yml` file as needed, then start the application using Docker Compose:**
...
**upload file**
```bash
curl -T 1.tgz http://localhost:18080/upload/1.tgz
```
**download file**
```bash
curl http://localhost:18080/download/1.tgz -o 2.tgz
```
